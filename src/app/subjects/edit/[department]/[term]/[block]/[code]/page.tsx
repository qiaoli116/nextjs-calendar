...
import { SubjectUpdateComponent, SubjectViewOneComponent } from '@/components/Sections/Subject';
...
export default function SubjectsUpdate({ params }: { params: { department: string, term: string, block: string, code: string } }) {
